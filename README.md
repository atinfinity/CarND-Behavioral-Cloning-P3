...
* [drive.py](https://github.com/udacity/CarND-Behavioral-Cloning-P3/blob/master/drive.py)
* [video.py](https://github.com/udacity/CarND-Behavioral-Cloning-P3/blob/master/video.py)
* [writeup_template.md](https://github.com/udacity/CarND-Behavioral-Cloning-P3/blob/master/writeup_template.md)
...
## Materials
* [model.py](https://github.com/atinfinity/CarND-Behavioral-Cloning-P3/blob/master/model.py) (script used to create and train the model)
* [drive.py](https://github.com/atinfinity/CarND-Behavioral-Cloning-P3/blob/master/drive.py) (script to drive the car - feel free to modify this file)
